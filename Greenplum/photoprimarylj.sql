...
-- 删除表 
drop table PhotoPrimary;

-- 导入表
copy "public".PhotoPrimary from '/home/gpadmin/load/comma/PhotoPrimary.csv' with DELIMITER ',' csv header;
-- linux shell comma
/usr/bin/time -v -o runPhoPri.txt psql -d astronomy -c "copy PhotoPrimaryLJ from '/home/gpadmin/load/comma/PhotoPrimaryLJ1000.csv' with DELIMITER ',' csv header;" 
-- linux shell tab
/usr/bin/time -v -o runPhoPri.txt psql -d astronomy -c "copy PhotoPrimaryLJ from '/home/gpadmin/load/tab/PhotoPrimaryLJ10.csv' with DELIMITER '\t';"  

-- 单表查询
explain analyze SELECT objID, ra , dec FROM PhotoPrimaryLJ WHERE ra > 185 and ra < 185.1 AND dec > 15 and dec < 15.1;

-- 两表查询 photoprimarylj/neighbors
